        ...
        <div class="page-container row-fluid container-fluid">
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper">
                    ...
                    <ul class='wraplist'>
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu" >
                                <li>
                                    <a class="" href="/gestpann/nouveltaille"  >Nouvelle taille</a>
                                </li>
                                <li>
                                    <a class="" href="/gestpann/taille"  >Actualiser</a>
                                </li>
                                <li>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper row" style=''>
                    ...
                    <div class='col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                ...
                                <h1 class="title">Gestion TAILLE (Dimension)</h1>
                    ...
                    <c:if test="${!empty nouveltaille || !empty taille}">
                        <div class="col-xl-12">
                              <section class="box ">
                                  <header class="panel_header">
                                      <h2 class="title float-left">AJOUT NOUVELLE TAILLE</h2>
                                  ...
                                  <div class="content-body">
                                      <form id="general_validate" method="POST"
                                        action="${(!empty taille) ? '/gestpann/modifiertaille' : '/gestpann/creertaille' }"
                                                  ...
                                                  <div class="form-group">
                                                      <label class="form-label">Id</label>
                                                          ...
                                                          <input disabled type="text" class="form-control" name="id"
                                                            value="${(!empty taille) ? taille.getIdtai() : '' }" id="id" >
                                                      </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="controls">
                                                          <input type="text" class="form-control" name="libelle"
                                                           value="${(!empty taille) ? taille.getLibelle() : '' }"
                                                           >
                                                      </div>
                                                  </div>
                                              </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="controls">
                                                          <input type="text" class="form-control" name="valeur"
                                                           value="${(!empty taille) ? taille.getValeur() : '' }"
                                                           >
                                                      </div>
                                                  </div>
                                              </div>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Liste des Tailles</h2>
                                <div class="actions panel_actions float-right">
                                    <a class="box_toggle fa fa-chevron-down"></a>
                                    <a class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></a>
                                    <a class="box_close fa fa-times"></a>
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
												...
												<c:forEach items="${listTaille}" var="taille" >
													<tr>
														<td>${ taille.getLibelle() }</td>
														<td>${ taille.getValeur() }</td>
														<td><a class="box_toggle fa fa-wrench"
														    href="/gestpann/modiftaille/${ taille.getIdtai() }"></a></td>
													</tr>
												</c:forEach>
                                            </tbody>
                                        </table>

                    ...
                    <div class='col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                ...
                                <h1 class="title">Historique des publications</h1>
                    ...
                    <div class="col-xl-12">
                          <section class="box ">
                              <header class="panel_header">
                                  <h2 class="title float-left">Historique</h2>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="controls">
                                                      <input id="ddbut" type="text" class="form-control datepicker" name="debut"
                                                       value="${(!empty datedebut) ? datedebut : '' }"
                                                       >
                                                  </div>
                                              </div>
                                          </div>

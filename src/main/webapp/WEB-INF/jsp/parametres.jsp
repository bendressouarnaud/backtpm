...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Gestion | PARAMETRES</title>
        ...
        <div class="page-container row-fluid container-fluid">
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper">
                    ...
                    <ul class='wraplist'>
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu" >
                                <li>
                                    <a class="" href="/gestpann/parametres"  >Actualiser</a>
                                </li>
                                <li>
                                    <a class="" href="/gestpann/acc"  >Accueil</a>
                                </li>
                            </ul>
                        </li>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper row" style=''>
                    ...
                    <div class='col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                ...
                                <h1 class="title">Gestion PARAMETRES</h1>
                    ...
                    <c:if test="${!empty modifparam }">
                        <div class="col-xl-12">
                              <section class="box ">
                                  <header class="panel_header">
                                      <h2 class="title float-left">MODIFICATION</h2>
                                  ...
                                  <div class="content-body">
                                      <form id="general_validate" method="POST"
                                        action="/gestpann/modifierparametres"
                                        >
                                          <div class="row">

                                              <div class="col-6">
                                                 <div class="form-group">
                                                     <label class="form-label">Choisir</label>
                                                     <div class="controls">
                                                        <select class="select2" name="enregsupport">
                                                            <option value="0">D&eacute;sactiver</option>
                        ...
                        <div class="col-xl-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Liste des param&egrave;tres</h2>
                                    <div class="actions panel_actions float-right">
                                        <a class="box_toggle fa fa-chevron-down"></a>
                                        <a class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></a>
                                        <a class="box_close fa fa-times"></a>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-12 padding-0">
                                            ...
                                            <table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>${ prm.getIdpar() }</td>
                                                        <td>${ prm.getEnregsupport() == 0 ? 'D&eacute;sactiv&eacute;' : 'Activ&eacute;' }</td>
                                                        <td><a class="box_toggle fa fa-wrench"
                                                            href="/gestpann/modifprms"></a></td>
                                                    </tr>
                                                </tbody>
                                            </table>

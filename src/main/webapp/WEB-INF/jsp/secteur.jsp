        ...
        <div class="page-container row-fluid container-fluid">
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper">
                    ...
                    <ul class='wraplist'>
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu" >
                                <li>
                                    <a class="" href="/gestpann/nouvelsecteur"  >Nouveau secteur</a>
                                </li>
                                <li>
                                    <a class="" href="/gestpann/secteur"  >Actualiser</a>
                                </li>
                                <li>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper row" style=''>
                    ...
                    <div class='col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                ...
                                <h1 class="title">Gestion SECTEUR</h1>
                    ...
                    <c:if test="${!empty nouvelsecteur || !empty secteur}">
                        <div class="col-xl-12">
                              <section class="box ">
                                  <header class="panel_header">
                                      <h2 class="title float-left">AJOUT NOUVEAU SECTEUR</h2>
                                  ...
                                  <div class="content-body">
                                      <form id="general_validate" method="POST"
                                        action="${(!empty secteur) ? '/gestpann/modifiersecteur' : '/gestpann/creersecteur' }"
                                          ...
                                          <div class="row">
                                                  ...
                                                  <div class="form-group">
                                                      <label class="form-label">Id</label>
                                                          ...
                                                          <input disabled type="text" class="form-control" name="id"
                                                            value="${(!empty secteur) ? secteur.getIdsec() : '' }" id="id" >
                                                      </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="controls">
                                                          <input type="text" class="form-control" name="libelle"
                                                           value="${(!empty secteur) ? secteur.getLibelle() : '' }"
                                                           >
                                                      </div>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="col-6">
                                                  <div class="form-group">
                                                      ...
                                                      <div class="controls">
                                                          <select class="select2"  name="quartier">
                                                              <c:forEach items="${listQuartier}" var="quartier" >
                                                                  <option value="${ quartier.getIdqua() }"
                                                                    ${ (!empty secteur) ? (secteur.getIdquar()==quartier.getIdqua()) ? "selected" : "" : ""}>
                                                                    ${ quartier.getLibelle() }
                                                                  </option>
                                                              </c:forEach>
                                                          </select>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Liste des Secteurs</h2>
                                <div class="actions panel_actions float-right">
                                    <a class="box_toggle fa fa-chevron-down"></a>
                                    <a class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></a>
                                    <a class="box_close fa fa-times"></a>
												...
												<c:forEach items="${listSecteur}" var="secteur" >
													<tr>
														...
														<td><a class="box_toggle fa fa-wrench"
														    href="/gestpann/modifsecteur/${ secteur.getIdsec() }"></a></td>
													</tr>
												</c:forEach>
                                            </tbody>
                                        </table>

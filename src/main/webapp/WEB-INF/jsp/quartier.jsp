        ...
        <div class="page-container row-fluid container-fluid">
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper">
                    ...
                    <ul class='wraplist'>
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu" >
                                <li>
                                    <a class="" href="/gestpann/nouvelquartier"  >Nouveau quartier</a>
                                </li>
                                <li>
                                    <a class="" href="/gestpann/quartier"  >Actualiser</a>
                                </li>
                                <li>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper row" style=''>
                    ...
                    <div class='col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                ...
                                <h1 class="title">Gestion QUARTIER</h1>
                    ...
                    <c:if test="${!empty nouvelquartier || !empty quartier}">
                        <div class="col-xl-12">
                              <section class="box ">
                                  <header class="panel_header">
                                      <h2 class="title float-left">AJOUT NOUVEAU QUARTIER</h2>
                                  ...
                                  <div class="content-body">
                                      <form id="general_validate" method="POST"
                                        action="${(!empty quartier) ? '/gestpann/modifierquartier' : '/gestpann/creerquartier' }"
                                                  ...
                                                  <div class="form-group">
                                                      <label class="form-label">Id</label>
                                                          ...
                                                          <input disabled type="text" class="form-control" name="id"
                                                            value="${(!empty quartier) ? quartier.getIdqua() : '' }" id="id" >
                                                      </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="controls">
                                                          <input type="text" class="form-control" name="libelle"
                                                           value="${(!empty quartier) ? quartier.getLibelle() : '' }"
                                                           >
                                                      </div>
                                                  </div>
                                              </div>
                                                          ...
                                                          <select class="select2"  name="ville">
                                                              <c:forEach items="${listVille}" var="ville" >
                                                                  <option value="${ ville.getIdvil() }"
                                                                    ${ (!empty quartier) ? (quartier.getIdvill()==ville.getIdvil()) ? "selected" : "" : ""}>
                                                                    ${ ville.getLibelle() }
                                                                  </option>
                                                              </c:forEach>
                                                          </select>
                    ...
                    <c:if test="${!empty recherche}">
                        <div class="col-xl-12">
                              <section class="box ">
                                  <header class="panel_header">
                                      <h2 class="title float-left">Filtre QUARTIER</h2>
                                      <div class="actions panel_actions float-right">
                                          <a class="box_toggle fa fa-chevron-down"></a>
                                      </div>
                                  </header>
                                  <div class="content-body">
                                      <form id="general_validate" method="POST"
                                        action="/gestpann/recherchequartier">
                                          <div class="row">
                    ...
                    <c:if test="${!empty listQuartier}">
						<div class="col-xl-12">
							<section class="box ">
								<header class="panel_header">
									<h2 class="title float-left">Liste des Quartiers</h2>
									<div class="actions panel_actions float-right">
										<a class="box_toggle fa fa-chevron-down"></a>
										<a class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></a>
										<a class="box_close fa fa-times"></a>
												...
												<tbody>
													...
													<c:forEach items="${listQuartier}" var="quartier" >
														<tr>
															...
															<td><a class="box_toggle fa fa-wrench" href="/gestpann/modifquartier/${quartier.getIdqua()}"></a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>

...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Gestion | Requ&ecirc;tes panneaux</title>
        ...
        <div class="page-container row-fluid container-fluid">
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper">
                    ...
                    <ul class='wraplist'>
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu" >
                                <li>
                                    <a class="" href="/gestpann/nouvrequetepan"  >Nouvelle requ&ecirc;te</a>
                                </li>
                                <li>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper row" style=''>
                    ...
                    <div class='col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                ...
                                <h1 class="title">Gestion REQU&Ecirc;TE</h1>
                    ...
                    <c:if test="${!empty nouvrequetepan || !empty requetepan}">
                        <div class="col-xl-12">
                              <section class="box ">
                                  <header class="panel_header">
                                      <h2 class="title float-left">NOUVELLE REQU&Ecirc;TE</h2>
                                  ...
                                  <div class="content-body">
                                      <form id="general_validate" method="POST"
                                        action="${(!empty requetepan) ? '/gestpann/modifierrequetepan' : '/gestpann/creerrequetepan' }"
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-6">
                                                  ...
                                                  <div class="form-group">
                                                      <label class="form-label">Id</label>
                                                          ...
                                                          <input disabled type="text" class="form-control" name="id"
                                                            value="${(!empty requetepan) ? requetepan.getIdrqtpn() : '' }" id="id" >
                                                      </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="controls">
                                                          <select class="select2" name="panneau">
                                                              <c:forEach items="${listePanneau}" var="panneau" >
                                                                  <option value="${ panneau[0] }"
                                                                    ${ (!empty requetepan) ? (requetepan.getIdpan()==panneau[0]) ? "selected" : "" : ""}>
                                                                    ${ panneau[1] }
                                                                  </option>
                                                              </c:forEach>
                                                          </select>
                                                     ...
                                                     <div class="controls">
                                                          <select class="select2" name="utilisateur">
                                                              <c:forEach items="${listUtilisateur}" var="utilisateur" >
                                                                  <option value="${ utilisateur.getIdusr() }"
                                                                    ${ (!empty requetepan) ? (requetepan.getIduser()==utilisateur.getIdusr()) ? "selected" : "" : ""}>
                                                                    ${ utilisateur.getNom() }
                                                                  </option>
                                                              </c:forEach>
                                                          </select>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12 padding-0">
                                        ...
                                        <table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <c:forEach items="${histoRequetes}" var="requetes" >
                                                	<tr>
                                                		<td>${ requetes[0] }</td>
                                                		<td>${ requetes[1] }</td>
                                                		<td>${ requetes[2] }</td>
                                                		<td>${ fn:replace(requetes[3], '00:00:00.0', '') }</td>
                                                		<td>${ requetes[4]==0 ? "En attente" : "Trait&eacute;"}</td>
                                                		<td><a class="box_toggle fa fa-wrench"
                                                		    href="/gestpann/modifrequetepan/${ requetes[5] }"></a></td>
                                                	</tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>

        ...
        <div class="page-container row-fluid container-fluid">
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper row" style=''>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                              ...
                              <div class="content-body">
                                  <form id="general_validate" method="POST" action="/gestpann/soumettrejournal"
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-6">
                                             <div class="form-group">
                                                 ...
                                                 <div class="controls">
                                                      <select class="select2" name="utilisateur" id="utilisateur">
                                                          <c:forEach items="${histoJournal}" var="histo" >
                                                              <option value="${ histo[0] }">
                                                                ${ histo[1] }
                                                              </option>
                                                          </c:forEach>
                                                      </select>
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <div class="controls">
                                                      <select class="select2" name="choix"
                                                        id="choix" >
                                                         <option value="0">Rapport p&eacute;riodique de l'utilisateur</option>
                                                         <option value="1">Rapport p&eacute;riodique de tous les utilisateurs</option>
                                                         <option value="2">Supports cr&eacute;&eacute;s par l'utilisateur</option>
                                                         <option value="3">Supports cr&eacute;&eacute;s par tous les utilisateurs</option>
                                                         <option value="4">Supports par commune</option>
                                                         <option value="5">Co&ucirc;t par commune et par support</option>
                                                      </select>
                                                 </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-6">
                                             <div class="form-group">
                                                 ...
                                                 <div class="controls">
                                                      <select class="select2" name="commune" id="commune">
                                                          <c:forEach items="${listeCommune}" var="commune" >
                                          ...
                                          <div class="col-6">
                                             <div class="form-group">
                                                 <label class="form-label" style="font-weight:bold">Type de support (Uniquement pour SUPPORTS PAR COMMUNE)</label>
                                                 <div class="controls">
                                                      <select class="select2" name="typesupport" id="typesupport">
                                                          <option value="0">Aucun choix (Tous les types par d&eacute;faut)</option>
                                                          <c:forEach items="${listeTypes}" var="ltype" >
                                                              <option value="${ ltype.getIdtyp() }">
                                                                ${ ltype.getLibelle() }
                                                              </option>
                                                          </c:forEach>
                                                      </select>
                                          ...
                                          <div class="col-12">
                                              <div class="float-right ">
                                                  <button type="submit" name="generer" value="0" class="btn btn-warning">G&eacute;n&eacute;rer le rapport</button>
                                                  <button type="submit" name="generer" value="1" id="valider" class="btn btn-success">Afficher</button>
                                              </div>
                                          </div>
                                      </div>
                                  </form>
                    ...
                    <c:if test="${!empty donneesutilisateurs}">
                        <div class="col-xl-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Historique des actions des utilisateurs</h2>
                                    <div class="actions panel_actions float-right">
                                        <a class="box_toggle fa fa-chevron-down"></a>
                                    </div>
                                </header>
                                            ...
                                            <table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${listeJournal}" var="journal" >
                                                        <tr>
                                                            <td>${ journal[0] }</td>
                                                            <td>${ fn:replace(journal[1], '00:00:00.0', '') }</td>
                                                            <td>${ journal[2] }</td>
                                                            <td>${ journal[3] }</td>
                                                        </tr>
                                                    </c:forEach>
                    ...
                    <!-- Supports créés  par l'utilisateur : -->
                    <c:if test="${!empty histocreationUtilisateur}">
                        <div class="col-xl-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Historique des supports cr&eacute;&eacute;s par l'utilisateur</h2>
                                    <div class="actions panel_actions float-right">
                                        <a class="box_toggle fa fa-chevron-down"></a>
                                    </div>
                                </header>
                                            ...
                                            <table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Heure de cr&eacute;ation</th>
                                                        <th>Emplacement</th>
                                                        <th>Type</th>
                                                        <th>Secteur</th>
                                                        <th>Quartier</th>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${histocreationUtilisateur}" var="histo" >
                                                        <tr>
                                                            <td>${ histo[0] }</td>
                                                            <td>${ histo[1] }</td>
                                                            <td>${ fn:replace(histo[2], '00:00:00.0', '') }</td>
                                                            <td>${ histo[3] }</td>
                                                            <td>${ histo[4] }</td>
                                                            <td>${ histo[5] }</td>
                                                            <td>${ histo[6] }</td>

            ...
            <section id="main-content" class=" ">
                    ...
                    <div class="col-xl-12">
                          <section class="box ">
                              <header class="panel_header">
                                  <h2 class="title float-left">Saisir votre requ&ecirc;te ...</h2>
                              ...
                              <div class="content-body">
                                  <form id="general_validate" method="POST"
                                    action="/gestpann/sendwebselect">
                                      <div class="row">


                                          <div class="col-12">
                                              <textarea class="bootstrap-wysihtml5-textarea" placeholder="Enter text ..." style="width: 100%; height: 250px; font-size: 14px; line-height: 23px;padding:15px;"
                                                    name="requete">${(!empty requete) ? requete : "" }</textarea>
                                          </div>
                ...
                <c:if test="${!empty ok }">
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">R&eacute;sultat</h2>
                                <div class="actions panel_actions float-right">
                                    <a class="box_toggle fa fa-chevron-down"></a>
                                </div>
                            </header>
                                        ...
                                        <table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <c:forEach items="${colonnes}" var="colonness" >
                                                        <th>${colonness}</th>
                                                    </c:forEach>
                                            ...
                                            <tbody>
												...
												<c:forEach items="${resultatRequete}" var="resultatRequete" >
													<tr>
													    <c:forEach var="i" begin="0" end="${ taille-1 }">
                                                            <td>${ resultatRequete[i] }</td>
                                                        </c:forEach>
													</tr>
												</c:forEach>

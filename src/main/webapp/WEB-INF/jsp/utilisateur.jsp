        ...
        <div class="page-container row-fluid container-fluid">
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper">
                    ...
                    <ul class='wraplist'>
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu" >
                                <li>
                                    <a class="" href="/gestpann/nouvutilisateur"  >Nouveau utilisateur</a>
                                </li>
                                <li>
                                    <a class="" href="/gestpann/gestionuser"  >Actualiser</a>
                                </li>
                                <li>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper row" style=''>
                    ...
                    <c:if test="${!empty nouvutilisateur || !empty utilisateur}">
                        <div class="col-xl-12">
                              <section class="box ">
                                  ...
                                  <div class="content-body">
                                      <form id="general_validate" method="POST"
                                        action="${(!empty utilisateur) ? '/gestpann/modifierutilisateur' : '/gestpann/creerutilisateur' }"
                                                  ...
                                                  <div class="form-group">
                                                      <label class="form-label">Id</label>
                                                          ...
                                                          <input disabled type="text" class="form-control" name="id"
                                                            value="${(!empty utilisateur) ? utilisateur.getIdusr() : '' }" id="id" >
                                                      </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="controls">
                                                          <input type="text" class="form-control" name="email"
                                                           value="${(!empty utilisateur) ? utilisateur.getEmail() : '' }"
                                                           >
                                                      </div>
                                                  </div>

                                                  <div class="form-group">
                                                      <label class="form-label">Num&eacute;ro</label>
                                                      <div class="controls">
                                                          <input type="text" class="form-control" name="numero"
                                                           value="${(!empty utilisateur) ? utilisateur.getNumero() : '' }"
                                                           >
                                                      </div>
                                                  </div>
                                              ...
                                              <div class="col-6">
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="controls">
                                                          ...
                                                          value="${(!empty utilisateur) ? utilisateur.getNom() : '' }"
                                                          >
                                                      </div>
                                                  </div>
                                                     ...
                                                     <div class="controls">
                                                         <select class="select2"  name="role">
                                                             <option value="superuser"
                                                               ${ (!empty utilisateur) ? (utilisateur.getRoles()=="superuser") ? "selected" : "" : ""}>
                                                               Super administrateur
                                                             </option>
                                                             <option value="admin"
                                                               ${ (!empty utilisateur) ? (utilisateur.getRoles()=="admin") ? "selected" : "" : ""}>
                                                               Administrateur
                                                             </option>
                                                             <option value="utilisateur"
                                                               ${ (!empty utilisateur) ? (utilisateur.getRoles()=="utilisateur") ? "selected" : "" : ""}>
                                                               Utilisateur
                                                             </option>
                                                         </select>
                                                     </div>
                                                 ...
                                                 <div class="form-group">
                                                     <label class="form-label">&Eacute;tat du compte</label>
                                                     <div class="controls">
                                                         <select class="select2"  name="etatcompte">
                                                             <option value="0"
                                                               ${ (!empty utilisateur) ? (utilisateur.getActif()==0) ? "selected" : "" : ""}>
                                                               Inactif
                                                             </option>
                                                             <option value="1"
                                                               ${ (!empty utilisateur) ? (utilisateur.getActif()==1) ? "selected" : "" : ""}>
                                                               Actif
                                                             </option>
                                                         </select>
                                                     </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-12 padding-0">
                                            ...
                                            <table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${listDonnees}" var="utilisateur" >
                                                        <tr>
                                                            <td>${ utilisateur.getNom() }</td>
                                                            <td>${ utilisateur.getEmail() }</td>
                                                            <td>${ (utilisateur.getActif()==0) ? "Inactif" : "Actif" }</td>
                                                            <td>${ utilisateur.getRoles() }</td>
                                                            <td><a class="box_toggle fa fa-wrench"
                                                                href="/gestpann/modifutilisateur/${ utilisateur.getIdusr() }"></a></td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
